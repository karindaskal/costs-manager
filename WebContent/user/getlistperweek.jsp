...
<div data-role="page" id="home" data-theme="b">
 ...
 <h1> Cost List Per Week</h1>
 </div>
 <a href="getlist.jsp" id="showregistration" data-ajax="false">back &rarr;</a> <label for="textinput-fc">Show data week back to date:
...
window.cost.showMessage("louding") 
window.cost.getListPerWeek(date,window.cost.showList,window.cost.showMessage);
}</script>
